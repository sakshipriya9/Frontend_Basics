document.addEventListener("DOMContentLoaded", () => {
    ...
    function prepareWrapperDivForCartItems(product, productQuantityMapping){
        ...
        document.getElementById("order-details").appendChild(orderDetailsProduct);
        document.getElementById("order-details").appendChild(hr);
    ...
    async function populateCart() {
        ...
        const CartProductDownloadPromise = CartProducts.map(product => {
            ...
            return fetchProductsById(product.productId);
        });
